  ...
  def switch(assigns) do
    ...
    <label class={cn([
      ...
      <input
        ...
        {@rest}
      />
      <div class="relative h-5 w-9 overflow-hidden rounded-full border-2 border-transparent bg-input outline-none transition-colors peer-checked:bg-primary peer-focus-visible:ring-2 peer-focus-visible:ring-ring peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-background peer-disabled:cursor-not-allowed">
