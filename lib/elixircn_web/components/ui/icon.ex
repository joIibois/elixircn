defmodule ElixircnWeb.Components.UI.Icon do
  @moduledoc "Provides an SVG icon component powered by a built-in Lucide icon set."
  ...
  defp icon_svg("grid-2x2"),
    do:
      ~s(<path d="M12 3v18" /> <path d="M3 12h18" /> <rect x="3" y="3" width="18" height="18" rx="2" />)

  defp icon_svg("info"),
    do: ~s(<circle cx="12" cy="12" r="10" /> <path d="M12 16v-4" /> <path d="M12 8h.01" />)

  defp icon_svg("layout-grid"),
    do:
  ...
  defp icon_svg("user"),
    do: ~s(<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" /> <circle cx="12" cy="7" r="4" />)
  ...
  defp icon_svg(name) do
    require Logger
    Logger.warning("Icon not found: #{inspect(name)}")
    ""
  end
end
